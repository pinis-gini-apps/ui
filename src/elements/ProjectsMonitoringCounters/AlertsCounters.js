...
const AlertsCounters = () => {
  ...
  return (
    <StatsCard className="monitoring-stats monitoring-stats_my-class">
      ...
      <StatsCard.Header>
        ...
        <div className="project-card__info">
          ...
          <span style={{ marginLeft: '8px' }}>Last 24 hours</span>
        </div>
      </StatsCard.Header>
      <StatsCard.Row>
        <StatsCard.Col>
        ...
        <StatsCard.Col>
          <div>
            <h6 className="stats__subtitle">Job</h6>
            <span className="stats__counter">
              {projectStore.projectsSummary.loading ? (
                <Loader section small secondary />
              ) : (
      ...
      {/*    <span*/}
      {/*      className="link"*/}
      {/*      onClick={() => navigate('default/alerts')}*/}
      {/*      data-testid="scheduled_jobs_see_all"*/}
      {/*    >*/}
      {/*      See all*/}
      {/*    </span>*/}
